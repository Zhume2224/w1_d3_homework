...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_return_10(self):
      return_10_result = return_10()#-->funcname
      self.assertEqual( 10, return_10_result )

#   @unittest.skip("delete this line to run the test")
  def test_add(self):
      add_result = add( 1, 2 )#-->add func will have the results in add_result
      self.assertEqual( 3, add_result )#-->comparing add_result to 3
...
#   @unittest.skip("delete this line to run the test")
  def test_volume_of_cube(self):
    #add test code here
    result_volume_of_cub=volume_of_cube(2)
    self.assertEqual( 8, result_volume_of_cub )
    pass
...
#   @unittest.skip("delete this line to run the test")
  def test_reverse_string(self):
    #add test code here
    test_string="apple"  
    result_reverse_string=reverse_string(test_string)
    self.assertEqual( "elppa", result_reverse_string )
    pass
...
#   @unittest.skip("delete this line to run the test")
  def test_fahrenheit_to_celsius(self):
    #add test code here
    result_fahrenheit_to_celsius=fahrenheit_to_celsius(50)
    self.assertEqual( 10,  result_fahrenheit_to_celsius )
